...
import 'schema/recommedation_record.dart';
import 'schema/hostel_datav2_record.dart';
import 'schema/city_record.dart';
import 'schema/users_memoir_record.dart';
...
import 'schema/choicechipsbiouser_record.dart';
import 'dart:async';
...
export 'schema/recommedation_record.dart';
export 'schema/hostel_datav2_record.dart';
export 'schema/city_record.dart';
export 'schema/users_memoir_record.dart';
...
export 'schema/choicechipsbiouser_record.dart';
...
Future<FFFirestorePage<TripsRecord>> queryTripsRecordPage({
  ...
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, TripsRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      TripsRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<TripsRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query RecommedationRecords (as a Stream and as a Future).
Future<int> queryRecommedationRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RecommedationRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RecommedationRecord>> queryRecommedationRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RecommedationRecord.collection,
      RecommedationRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RecommedationRecord>> queryRecommedationRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<RecommedationRecord>> queryRecommedationRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, RecommedationRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      RecommedationRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<RecommedationRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query HostelDatav2Records (as a Stream and as a Future).
Future<int> queryHostelDatav2RecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HostelDatav2Record.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HostelDatav2Record>> queryHostelDatav2Record({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HostelDatav2Record.collection,
      HostelDatav2Record.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HostelDatav2Record>> queryHostelDatav2RecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<HostelDatav2Record>> queryHostelDatav2RecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, HostelDatav2Record> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      HostelDatav2Record.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<HostelDatav2Record> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
Future<FFFirestorePage<CityRecord>> queryCityRecordPage({
  ...
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, CityRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      CityRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<CityRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query UsersMemoirRecords (as a Stream and as a Future).
Future<int> queryUsersMemoirRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UsersMemoirRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UsersMemoirRecord>> queryUsersMemoirRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UsersMemoirRecord.collection,
      UsersMemoirRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UsersMemoirRecord>> queryUsersMemoirRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<UsersMemoirRecord>> queryUsersMemoirRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, UsersMemoirRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      UsersMemoirRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<UsersMemoirRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query ChoicechipsbiouserRecords (as a Stream and as a Future).
Future<int> queryChoicechipsbiouserRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ChoicechipsbiouserRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ChoicechipsbiouserRecord>> queryChoicechipsbiouserRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ChoicechipsbiouserRecord.collection,
      ChoicechipsbiouserRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ChoicechipsbiouserRecord>> queryChoicechipsbiouserRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ChoicechipsbiouserRecord>>
    queryChoicechipsbiouserRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, ChoicechipsbiouserRecord>
      controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
        queryCollectionPage(
          ...
          if (isStream) {
            final streamSubscription = (page.dataStream)
                ?.listen((List<ChoicechipsbiouserRecord> data) {
              for (var item in data) {
                final itemIndexes = controller.itemList!
                    .asMap()
                    .map((k, v) => MapEntry(v.reference.id, k));

...
class TripsRecord extends FirestoreRecord {
  ...
  // "BookingDetail" field.
  List<StayruleDataStruct>? _bookingDetail;
  List<StayruleDataStruct> get bookingDetail => _bookingDetail ?? const [];
  bool hasBookingDetail() => _bookingDetail != null;
  ...
  void _initializeFields() {
    ...
    _bookingDetail = getStructList(
      snapshotData['BookingDetail'],
...
class TripsRecordDocumentEquality implements Equality<TripsRecord> {
  ...
  bool equals(TripsRecord? e1, TripsRecord? e2) {
    ...
    return e1?.userRef == e2?.userRef &&
        ...
        listEquality.equals(e1?.bookingDetail, e2?.bookingDetail);
  }

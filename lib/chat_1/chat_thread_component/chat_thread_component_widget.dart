...
import '/chat_1/chat_thread/chat_thread_widget.dart';
              ...
              stream: queryChatMessagesRecord(
                ...
                limit: 200,
                  ...
                  if (_model.listViewPreviousSnapshot != null &&
                    ...
                    logFirebaseEvent(
                        'CHAT_THREAD_COMPONENT_ListView_oku8fdp3_');
                    ...
                    return Container(
                      ...
                      child: wrapWithModel(
                        ...
                        child: ChatThreadWidget(
                          key: Key(
                            'Keyo1z_${listViewChatMessagesRecord.reference.id}',
                          ),
              ...
              if (currentUserReference != null) {
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: TextFormField(
                                        ...
                                        onFieldSubmitted: (_) async {
                                          logFirebaseEvent(
                                              'CHAT_THREAD_COMPONENT_TextField_grdomg1c');
                                          logFirebaseEvent(
                ...
                return Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('CHAT_THREAD_COMPONENT_JOIN_BTN_ON_TAP');

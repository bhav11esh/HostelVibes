...
class ReviewTripWidget extends StatefulWidget {
  ...
  final HostelDatav2Record? propertyReference;
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'xvxpgqde' /* Let us know what you thought o... */,
                          ),
                          textAlign: TextAlign.start,
                          style:
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'yqub7h46' /* How would you rate it? */,
                            ),
                            textAlign: TextAlign.start,
                            style:
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: FFLocalizations.of(context).getText(
                        'y0rz6cc9' /* Please leave a description of ... */,
                      ),
                      hintStyle:
                          FlutterFlowTheme.of(context).bodyMedium.override(
                                fontFamily: 'Urbanist',
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('REVIEW_TRIP_SUBMIT_REVIEW_BTN_ON_TAP');
                      ...
                      await ReviewsRecord.collection
                          ...
                          .set(createReviewsRecordData(
                            ...
                            propRef: widget.propertyReference?.reference,
                            userNickname: currentUserDisplayName,
                          ));
                      logFirebaseEvent('Button_backend_call');

                      await widget.propertyReference!.reference
                          .update(createHostelDatav2RecordData());
                      logFirebaseEvent('Button_backend_call');

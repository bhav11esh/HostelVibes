...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const Onboarding2Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              name: 'SearchFilters',
              path: 'searchFilters',
              builder: (context, params) => const SearchFiltersWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              asyncParams: {
                'propertyRef':
                    getDoc(['HostelDatav2'], HostelDatav2Record.fromSnapshot),
              },
            ...
            FFRoute(
              ...
              builder: (context, params) => BookNowPageWidget(
            ...
            FFRoute(
              name: 'FIlters_for_hostel',
              path: 'fIltersForHostel',
              builder: (context, params) => const FIltersForHostelWidget(),
            ),
            FFRoute(
              name: 'Diary',
              path: 'Diary',
            ...
            FFRoute(
              name: 'onclickconnections',
              path: 'onclickconnections',
              requireAuth: true,
              builder: (context, params) => OnclickconnectionsWidget(
                userHostelTripRef: params.getParam<DocumentReference>(
                  'userHostelTripRef',
                  ParamType.DocumentReference,
                  isList: true,
            ...
            FFRoute(
              ...
              builder: (context, params) => FriendBioWidget(
                userProfile: params.getParam(
                  'userProfile',
                  ParamType.Document,
                ),
            ...
            FFRoute(
              name: 'Details08Facility',
              path: 'details08Facility',
              builder: (context, params) => const Details08FacilityWidget(),
            ),
            FFRoute(
              name: 'Phonesignin',
              path: 'phonesignin',
            ...
            FFRoute(
              name: 'chat_2_InviteUsersCopy',
              path: 'chat2InviteUsersCommunity',
              asyncParams: {
                'chatRef': getDoc(['chats'], ChatsRecord.fromSnapshot),
              },
              builder: (context, params) => Chat2InviteUsersCopyWidget(
                chatRef: params.getParam(
                  'chatRef',
                  ParamType.Document,
                ),
                usertripRef: params.getParam<DocumentReference>(
                  'usertripRef',
                  ParamType.DocumentReference,
                  isList: true,
                  collectionNamePath: ['users'],
                ),
                hostelid: params.getParam(
                  'hostelid',
                  ParamType.int,
                ),
              ),

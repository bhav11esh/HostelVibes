...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = pandaTravelFirebaseUserStream()
  ...
  Widget build(BuildContext context) {
    return MaterialApp.router(
      title: 'Hostel  Travel  and Friends',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        margin: const EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 10.0, 5.0),

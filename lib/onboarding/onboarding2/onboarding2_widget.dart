...
class _Onboarding2WidgetState extends State<Onboarding2Widget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('Onboarding2_set_dark_mode_settings');
                        ...
                        itemBuilder: (context, index) {
                          return [
                            ...
                            () => ClipRRect(
                                  ...
                                  child: Image.network(
                                    'https://images.unsplash.com/photo-1509233725247-49e657c54213?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwzfHxiZWFjaHxlbnwwfHx8fDE2OTY1OTk0NTd8MA&ixlib=rb-4.0.3&q=80&w=1080',
                                    width: 120.0,
                                    height: 160.0,
                                    fit: BoxFit.cover,
                                  ),
                      ...
                      children: [
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'i3edr555' /* Travel in best hostels */,
                                            ),
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'zd3cwe8o' /* Travelling  made super easy & ... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'xny28fug' /* Booking.com, Hostelworld, Make... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '01dauxev' /* Meet Other Travellers */,
                                            ),
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .displaySmall
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '75jhlswr' /* Make new friends along the way... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                                  FlutterFlowTheme.of(context)
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ONBOARDING2_PAGE_HOME_BTN_ON_TAP');

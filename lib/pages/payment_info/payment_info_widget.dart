...
class _PaymentInfoWidgetState extends State<PaymentInfoWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('PAYMENT_INFO_paymentInfo_ON_INIT_STATE');
      logFirebaseEvent('paymentInfo_google_analytics_event');
      logFirebaseEvent('paymentpage');
    });
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('PAYMENT_INFO_arrow_back_rounded_ICN_ON_T');
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'PAYMENT_INFO_PAGE_chatGuest_ON_TAP');
                          logFirebaseEvent('chatGuest_navigate_back');
                          context.pop();
                        },
                        text: FFLocalizations.of(context).getText(
                          '79crxl1b' /* Save Changes */,
                        ),

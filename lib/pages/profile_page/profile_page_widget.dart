...
class _ProfilePageWidgetState extends State<ProfilePageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('profilePage_google_analytics_event');
      logFirebaseEvent('profilepage');
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                columnUsersRecord.photoUrl != ''
                                    ? columnUsersRecord.photoUrl
                                    : 'https://ui-avatars.com/api/?rounded=true&name=${columnUsersRecord.displayName}',
                                width: 80.0,
                                height: 80.0,
                                fit: BoxFit.cover,
                              ),
                              ...
                              children: [
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PROFILE_PAGE_PAGE_Icon_hvas2u6q_ON_TAP');
                                            logFirebaseEvent(
                                                'Icon_launch_u_r_l');
                                ...
                                AuthUserStreamWidget(
                                  builder: (context) => SelectionArea(
                                      child: Text(
                                    'Status : ${valueOrDefault(currentUserDocument?.bio, '') != '' ? valueOrDefault(currentUserDocument?.bio, '') : 'Update your status'}'
                                        .maybeHandleOverflow(
                                      maxChars: 75,
                                      replacement: '…',
                                    ),
                                    ...
                                    Expanded(
                                      child: AuthUserStreamWidget(
                                        builder: (context) =>
                                          ...
                                          options: (currentUserDocument?.bio1
                                                      .toList() ??
                                                  [])
                                              .take(3)
                                              .toList()
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              if (valueOrDefault(
                                      currentUserDocument?.walletPoints, 0.0) >
                                  0.0)
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                      0.0, 0.0, 20.0, 0.0),
                                  child: AuthUserStreamWidget(
                                    builder: (context) => Text(
                                      'Wallet Balance : ${formatNumber(
                                        valueOrDefault(
                                            currentUserDocument?.walletPoints,
                                            0.0),
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('PROFILE_Container_3i0yyegg_ON_TAP');
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      highlightColor: Colors.transparent,
                      onTap: () async {
                        logFirebaseEvent('PROFILE_Container_a1vrxm51_ON_TAP');
                        logFirebaseEvent('Container_navigate_to');
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('PROFILE_Container_mw1qudbh_ON_TAP');
                          logFirebaseEvent('Container_navigate_to');
                    ...
                    children: [
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'PROFILE_Container_5egs3kf5_ON_TAP');
                            logFirebaseEvent('Container_navigate_to');
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'PROFILE_PAGE_PAGE_Row_g2rz3jsy_ON_TAP');
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          logFirebaseEvent('PROFILE_Container_jko4r6ci_ON_TAP');
                          logFirebaseEvent('Container_navigate_to');
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'PROFILE_PAGE_PAGE_Row_09g6gcrw_ON_TAP');
                                  logFirebaseEvent('Row_launch_u_r_l');
                                  await launchURL('https://wa.me/7755048188');
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  mainAxisAlignment:
